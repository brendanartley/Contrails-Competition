...
config = SimpleNamespace(
    ...
    # models = ["bfg_1", "bfg_2", 'pretty-microwave-583', 'treasured-waterfall-590', 'iconic-field-657'], # 0.6791
    models = ["bfg_1", "bfg_2", 'pretty-microwave-583', 'treasured-waterfall-590', 'bfg_852'], # 0.6800
)
